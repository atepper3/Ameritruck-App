...
// Assuming you've imported the necessary Firestore functions at the top of your file
export const addTruck = (truckData) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: ADD_TRUCK,
      payload: { ...truckData, id: docRef.id }, // Include the new truck's Firestore ID in the payload
    });
  } catch (error) {
...
export const updateExpense =
  (truckId, expenseId, expenseData) => async (dispatch) => {
...
export const updateCommission =
  (truckId, commissionId, commissionData) => async (dispatch) => {
