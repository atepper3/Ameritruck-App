...
import { fetchTruckDetails, updateTruckDetails } from '../../store/actions/truckActions';
            ...
            <Form onSubmit={handleSubmit} className="text-small">
                ...
                <Row xs={1} md={2} className="g-2">
                    ...
                    <div className="d-grid gap-2">
                        <Button type="submit" variant="success" size="sm" className="mt-2">Save Changes</Button>
                    </div>
            </Form>
        </Container>
    );
