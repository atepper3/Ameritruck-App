...
import { addCommission, updateCommission } from '../../store/actions/truckActions';
    ...
    return (
        <Modal show={show} onHide={() => {
            ...
            <Modal.Header closeButton>
                <Modal.Title>{commissionData?.id ? 'Edit Commission' : 'Add Commission'}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Form onSubmit={handleSubmit}>
                    <Form.Group className="mb-3">
                        <Form.Label>Type</Form.Label>
                        <Form.Select name="type" value={commission.type} onChange={handleChange} required>
                    ...
                    <div className="text-end">
                        ...
                        <Button variant="primary" type="submit">{commissionData?.id ? 'Update' : 'Add'} Commission</Button>
                    </div>
                </Form>
            </Modal.Body>
        </Modal>
